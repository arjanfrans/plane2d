...
/// @brief Command line arguments for application if specified using el::Helpers::setArgs(..) or START_LOGGER(..)
...
#if defined(ELPP_UNICODE)
#   define START_LOGGER(argc, argv) el::Helpers::setArgs(argc, argv); std::locale::global(std::locale(""))
#else
